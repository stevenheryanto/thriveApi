...
class SendEmailAwbShareCourse implements ShouldQueue
{
    ...
    public function handle()
    {
        $this->sendEmail(
            ...
            $this->details['courseTitle'],
            $this->details['courseUrl'],
            $this->details['courseDescription'],
            $this->details['courseId'],
        );
    }

    private function sendEmail( $toEmail, $toName, $userName, $courseTitle, $courseUrl, $courseDescription, $courseId)
    {
        ...
        try {
            ...
            $body = str_replace('@EmailFromemployeeName', $userName, $body);
            $body = str_replace('@ArticleTitle', $courseTitle, $body);
            $body = str_replace('@ArticleUrl', $courseUrl, $body);
            $body = str_replace('@ArticleDescription', $courseDescription, $body);
            ...
            $array_log = array('sender_name' => $userName,
                'subject' => $subject,
                'email_to' => $toEmail,
                'email_body' => $body,
                'flag_email' => 1,
