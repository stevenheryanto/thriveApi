...
use DB_global;
use App\Models\Findtime\ideation_slider;
use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use Illuminate\Http\Response;
use Illuminate\Support\Facades\Storage;

class IdeationSliderController extends Controller
{
    protected $table_name = 'ideation_slider';
    protected $folder_name = 'ideation/slider';
