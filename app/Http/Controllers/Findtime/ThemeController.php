...
{
    protected $folder_name = 'ideation/theme';
    protected $table = 'ideation_theme';
    ...
    public function ListData(Request $request)
    {
        ...
        $sql = "select a.* from $this->table a left join ideation_platform_hdr b on a.platform_id = b.id where b.status_active = 1 and b.id = :platform_id and a.is_deleted is null order by a.date_modified desc";
    ...
    public function InsertData(Request $request)
    {
        ...
        $sqlColumnImg = "SHOW columns FROM ideation_theme WHERE field like 'img_%' ";
