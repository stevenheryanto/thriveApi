...
{
    //
    protected $folder_name = 'menu/theme';

    protected $table = 'menu_theme';
    ...
    public function ListData(Request $request){
        ...
        $sql = "select a.* from $this->table a left join menu_platform_hdr b on a.platform_id = b.id where b.status_active = 1 and b.id = :platform_id and a.is_deleted is null order by a.date_modified desc";
    ...
    public function InsertData(Request $request)
    {
        $arrFieldImageFile = array(
            "img_logo_menu","img_logo_slogan",
            "img_whatshot","img_learn_and_live",
            "img_icon_admin","img_engagement",
            "img_lang","img_prev_slide_engagement",
            "img_next_slide_engagement","background_image"
        );
