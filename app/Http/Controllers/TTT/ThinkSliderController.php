...
use App\Models\TTT\Timetothink_slider;
...
class ThinkSliderController extends Controller{
    protected $table_name = 'timetothink_slider';
    protected $folder_name = 'think/slider';
    ...
    public function InsertData(Request $request)
    {
        ...
        unset($_arrayData['user_account'] , $_arrayData['slider_file'], $_arrayData['user_id']);
