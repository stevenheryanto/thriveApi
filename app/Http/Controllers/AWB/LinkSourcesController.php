...
use App\Models\AWB\awb_mst_link_source;

class LinkSourcesController extends Controller
{
    protected $table_name = 'awb_mst_link_source';
    ...
    public function ListData(Request $request)
    {
        ...
        try {
            ...
            $query = DB::table($this->table_name.' as a')->selectRaw('a.*,
                    md5(a.code) as md5_code')
                ->where('a.platform_id','=',$platform_id);

            if($category != "COUNT"){
                $data = $query->offset($offset)
                    ->limit($limit)
                    ->orderBy('a.source_name','asc')
                    ->get();
            } else {
                $data = $query->count();
            }
    ...
    public function SelectData(Request $request)
	{
        ...
        try {
            $query =  awb_mst_link_source::where(DB::RAW('md5(id)'), '=', $id);
            $data = $query->first();
