...
use App\Models\AWB\sw_mst_submod;

class SwSubModuleController extends Controller
{
    protected $table_name = 'sw_mst_submod';
    ...
    public function ListData(Request $request)
    {
        ...
        if(!empty($moduleId))
        {
            $wheremoduleId = "and a.module_id = :moduleId";
