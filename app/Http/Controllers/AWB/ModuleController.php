...
use App\Models\AWB\awb_mst_module;

class ModuleController extends Controller
{
    protected $table_name = 'awb_mst_module';
    protected $folder_name  = 'learn/module';
    ...
    public function InsertData(Request $request)
    {
        ...
        unset($_arrayData['user_account'] , $_arrayData['module_image'], $_arrayData['user_id']);
    ...
    public function UpdateData(Request $request)
    {
        $id         = $request->input('id');
        $user_id    = $request->input('user_id');
        $all        = $request->except('user_account','id','module_image','user_id');
        ...
        if($request->hasFile('module_image'))
        {
            ...
            $fileName = DB_global::cleanFileName($fileName);
            Storage::putFileAs($this->folder_name, $file, $fileName, 'public');
            $all = array_merge($all, ['module_image' => $fileName]);
        }
        $all = array_merge($all,
        array(
